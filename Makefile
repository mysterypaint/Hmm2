...
# For quick testing, I'm launching Citra if the program successfully compiles
CITRA		:=	C:/Users/User/AppData/Local/Citra/nightly-mingw/citra-qt.exe
...
# Your values.
APP_TITLE			:=	La-Mulana
APP_DESCRIPTION		:=	A fan port of the freeware version of La-Mulana.
APP_AUTHOR			:=	GR3Project
...
LIBS	:= -lmidifile3ds -lctru -lm

#---------------------------------------------------------------------------------
# list of directories containing libraries, this must be the top level containing
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(CTRULIB) $(CURDIR)/libmidifile3ds
